<template>
  <v-footer height="auto" dark color="deep-purple darken-1">
...
<script>
import VuejsIcon from 'vue-material-design-icons/Vuejs';
import LanguagePythonIcon from 'vue-material-design-icons/LanguagePython';
